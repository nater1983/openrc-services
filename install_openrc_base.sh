...
install -Dm755 "misc/${_udev}/init.d/udev-settle" "${DESTDIR}/${SYSCONFDIR}/init.d/udev-settle"
install -Dm644 "misc/${_udev}/conf.d/udev-trigger" "${DESTDIR}/${SYSCONFDIR}/conf.d/udev-trigger"
install -Dm755 "misc/${_udev}/init.d/udev-trigger" "${DESTDIR}/${SYSCONFDIR}/init.d/udev-trigger"
