...
install -Dm644 "misc/init.d/xdm.confd-4" "${DESTDIR}/${SYSCONFDIR}/conf.d/xdm"
install -Dm755 "misc/init.d/xdm.initd-11" "${DESTDIR}/${SYSCONFDIR}/init.d/xdm"
install -Dm755 "misc/init.d/xdm-setup.initd-1" "${DESTDIR}/${SYSCONFDIR}/init.d/xdm-setup"
