...
install -Dm644 "${_gentoo_uri}/sys-auth/rtkit.confd" "${DESTDIR}/${SYSCONFDIR}/conf.d/rtkit"
install -Dm755 "${_gentoo_uri}/sys-auth/rtkit.initd" "${DESTDIR}/${SYSCONFDIR}/init.d/rtkit"
...
install -Dm644 "${_gentoo_uri}/gui-libs/display-manager-init/files/gdm.confd" "${DESTDIR}/${SYSCONFDIR}/conf.d/gdm"
