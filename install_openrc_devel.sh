...
install -Dm644 "misc/gentoo-apache-2.4.34/init/apache2.confd" "${DESTDIR}/${SYSCONFDIR}/conf.d/httpd"
install -Dm755 "misc/gentoo-apache-2.4.34/init/apache2.initd" "${DESTDIR}/${SYSCONFDIR}/init.d/httpd"
